...
export default class Body extends React.Component {
  render() {
    ...
    let font =
      _.get(this.props, "pageContext.site.siteMetadata.base_font", null) || "sans-serif"
    return (
      <React.Fragment>
        <Helmet>
          <title>
          ...
          <body
            className={
              "layout-" +
              _.get(this.props, "pageContext.site.siteMetadata.layout_type", null) +
              " style-" +
        ...
        {(_.get(this.props, "pageContext.site.siteMetadata.header.has_primary_nav", null) ||
          _.get(
            this.props,
